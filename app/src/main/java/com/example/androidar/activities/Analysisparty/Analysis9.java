...
public class Analysis9 extends AppCompatActivity {

    private EditText emailEditText;
    private EditText passwordEditText;

    private Button emailLoginButton;
    private ImageButton leftButton9;
    private ImageButton rightButton9;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        leftButton9 = findViewById(R.id.analysisButtonLeft9);

        vibrator = (Vibrator)getSystemService(Context.VIBRATOR_SERVICE);

        leftButton9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                Log.d("DataStorage", "ModernScore saved: " + ModernScore);
                Log.d("DataStorage", "NorthEuropeScore: " + NorthEuropeScore);
                Log.d("DataStorage", "SimpleScore saved: " + SimpleScore);
                Log.d("DataStorage", "VintageScore saved: " + VintageScore);
                Log.d("DataStorage", "FrenchyScore saved: " + FrenchyScore);
                Log.d("DataStorage", "ClassicScore saved: " + ClassicScore);

                Intent intent = new Intent(Analysis9.this, Analysis10.class);
        ...
        rightButton9 = findViewById(R.id.analysisButtonRight9);

        rightButton9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
