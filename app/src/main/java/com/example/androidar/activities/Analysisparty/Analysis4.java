...
public class Analysis4 extends AppCompatActivity {

    private EditText emailEditText;
    private EditText passwordEditText;

    private Button emailLoginButton;
    private ImageButton leftButton4;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analysis4);
        ...
        leftButton4 = findViewById(R.id.analysisButtonLeft4);
        ...
        leftButton4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Analysis4.this, Analysis5.class);
        ...
        rightButton4 = findViewById(R.id.analysisButtonRight4);
