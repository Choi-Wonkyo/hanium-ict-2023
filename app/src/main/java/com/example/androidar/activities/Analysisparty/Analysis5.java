...
public class Analysis5 extends AppCompatActivity {

    private EditText emailEditText;
    private EditText passwordEditText;

    private Button emailLoginButton;
    private ImageButton leftButton5;
    private ImageButton rightButton5;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analysis5);
        ...
        leftButton5 = findViewById(R.id.analysisButtonLeft5);
        ...
        leftButton5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Analysis5.this, Analysis6.class);
        ...
        rightButton5 = findViewById(R.id.analysisButtonRight5);
